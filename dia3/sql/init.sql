...
(
    ...
    "PRECO" numeric(12, 2),
    PRIMARY KEY ("ID"),
    CONSTRAINT "PK_VIAGEM_USUARIO" FOREIGN KEY ("CODIGO_USUARIO")
        REFERENCES public."USUARIOS" ("CODIGO") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT "PK_VIAGEM_BICICLETA" FOREIGN KEY ("CODIGO_BICICLETA")
...
CREATE SEQUENCE public.usuários_sequence
    start 1
    increment 1;